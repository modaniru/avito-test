...
1. [Запуск](#запуск)
    ...
    3. [Получение access token'a](#получение-access-tokena)
    4. [Непосредственно запуск](#непосредственно-запуск)
2. [Описание эндпоинтов](#описание-эндпоинтов)
    1. [Postman](#postman)
    2. [Swagger](#swagger)
    3. [curl](#curl)
3. [Архитектура и возникшие вопросы](#архитектура-и-возникшие-вопросы)
    1. [Архитектура базы данных](#архитектура-базы-данных)
    2. [Возникшие вопросы и проблемы](#возникшие-вопросы-и-проблемы)
...
Окончательный запрос на создание таблиц представлен в db/postgres
